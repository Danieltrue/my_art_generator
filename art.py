...
class Artwork:
    def __init__(self,size=(500,500),grain_level=0.2,noise_level=2.5,noise_shift=2.0,debug=False):
    ...
    def add_debug(self):
        messages = [
            f"Generated Art: By Danny",
            f"Twitter:       @center_mod",
        ...
        drawer.multiline_text((20,20),'\n'.join(messages),font=fnt,fill=(0,0,0,255))
